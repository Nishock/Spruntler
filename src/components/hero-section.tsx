...
const HeroSection = () => {
  ...
  return (
    <motion.section
      ...
      className="ezy__header23 light pt-20 pb-8 md:pt-28 md:pb-12 lg:py-32 text-zinc-900 dark:text-white relative overflow-hidden z-10 min-h-[500px] md:h-[800px] flex items-center [mask-image:linear-gradient(to_bottom,transparent,black_20%,black_80%,transparent)] backdrop-blur-xl"
      style={{
    ...
    >
      ...
      {/* <motion.div
        ...
        className="absolute size-[200px] md:size-[580px] border border-white opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 filter blur-sm md:blur-xl"
      >
        <div className="absolute size-1 md:size-2 bg-white rounded-full top-1/2 left-0 -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute size-1 md:size-2 bg-white rounded-full top-0 left-1/2 -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute size-3 md:size-5 border border-white rounded-full top-1/2 left-full -translate-x-1/2 -translate-y-1/2 inline-flex items-center justify-center">
          <div className="size-1 md:size-2 bg-white rounded-full" />
        </div>
      </motion.div> */}
      ...
      {/* Content Section */}
      <div className="container px-4 mx-auto relative z-10 mt-12 md:mt-20 lg:mt-0">
        <div className="grid grid-cols-12 gap-y-10 lg:gap-x-8">
          <div className="col-span-12 lg:col-span-6 xl:pr-12 text-center lg:text-start">
            <div className="flex flex-col justify-center h-full px-4 sm:px-6 md:px-8">
              ...
              Welcome to Spruntler, where digital marketing meets a touch of magic and a whole lot of strategy. We turn your business from meh to marvelous with innovative, data-driven marketing, stunning websites, and creative content that doesn’t just get seen—it gets results.
              </p>
