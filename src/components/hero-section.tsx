...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content Section */}
      <div className="container px-20 mx-auto relative z-10 md:mt-10 lg:mt-0">
        <div className="grid grid-cols-12 gap-y-8 lg:gap-x-8">
          ...
          <div className="col-span-12 lg:col-span-6 xl:pr-12 flex items-center">
            <div className="flex flex-col justify-center w-full px-4 sm:px-6 md:px-8">
              <h2 className="text-center lg:text-left text-5xl sm:text-6xl md:text-6xl font-bold mb-8 md:mb-16 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
                Where Possibility <br className="hidden md:block" /> Encounters Worth.
              </h2>
              <p className="text-sm md:text-base leading-relaxed opacity-80 text-white mb-8 max-w-[600px] mx-auto lg:mx-0 text-center lg:text-left">
