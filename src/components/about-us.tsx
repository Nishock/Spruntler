...
const StoryItem: React.FC<StoryItemProps> = ({ item, index }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ml-24 md:ml-0 items-center text-center md:text-center">
...
export const AboutUs = () => {
    return (
        <motion.section
            style={{ backgroundImage: `url(${BackgroundStars.src})`, backgroundSize: "cover" }}
