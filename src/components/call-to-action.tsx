            ...
            <section className={"py-20 md:py-24"} ref={sectionRef}>
                <div className={"container"}>
                    <motion.div
                        ...
                        <div className={"absolute inset-0 bg-[rgb(54,40,255)] bg-blend-overlay [mask-image:radial-gradient(50%_50%_at_50%_35%,black,transparent)] group-hover:opacity-0 transition duration-700"} style={{ backgroundImage: `url(${BackgroundGrid.src})` }} />
                        <motion.div
                        ...
                        <div className={"relative"}>
                            ...
                            <div className={"flex justify-center mt-8"}>
                                <ActionButton label={"Contact Now"} />
                            </div>
                        </div>
                    </motion.div>
                </div>
